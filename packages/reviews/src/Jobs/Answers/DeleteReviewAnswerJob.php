...
final class DeleteReviewAnswerJob implements ShouldQueue, ShouldBeUnique
{
    use Batchable;
    use Dispatchable;
    ...
    public function handle(): void
    {
        app(ReviewAnswersService::class)
            ->delete($this->reviewAnswer);
    }

    public function uniqueId(): string
    {
        return "reviews.review-answer-{$this->reviewAnswer->id}.delete";
    }
}
