<template>
    <div class="rounded-lg flex w-40 flex flex-row flex-nowrap relative">
        <div :style="{'background-color': modelValue}"
             class="cursor-pointer Sborder-gray-200 border flex-grow rounded-l-xl"
             @click="showDropdown = true"></div>
        <input type="text"
               class="px-3 py-1.5 flex-shrink-0 w-28 rounded-r-xl border-gray-200"
               :value="modelValue"
