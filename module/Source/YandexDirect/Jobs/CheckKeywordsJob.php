...
use Module\Source\YandexDirect\Actions\CheckKeywordsAction;

final class CheckKeywordsJob implements ShouldQueue, ShouldBeUnique
{
    use Batchable;
    use Dispatchable;
