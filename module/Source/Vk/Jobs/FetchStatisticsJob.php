...
use Module\Source\Vk\Actions\Fetch\FetchStatisticsAction;
use Module\Source\Vk\Jobs\Middleware\VkFetchingThrottle;

final class FetchStatisticsJob implements ShouldQueue, ShouldBeUnique
{
    use Batchable;
    use Dispatchable;
    ...
    {
        app(FetchStatisticsAction::class)
