...
use Module\Source\YandexMetrika\Actions\Fetch\FetchEcommerceAction;

final class FetchEcommerceJob implements ShouldQueue, ShouldBeUnique
{
    use Batchable;
    use Dispatchable;
    ...
    {
        app(FetchEcommerceAction::class)
